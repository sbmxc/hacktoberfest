...
# Taking pivot as the last element of the array
...
def Partition(A, start, end): # with this method the pivot will return at its correct position
    pivot = A[end]    # Taking pivot as the last element of the array
    ...
    A[pIndex], A[end] = A[end], A[pIndex]   # swaps the pivot with the pivot index
